...
GEMINI_TASKS_MODEL = _get_str("GEMINI_TASKS_MODEL", "gemini-3.1-flash-lite-preview")
GEMINI_FALLBACK_MODEL = _get_str("GEMINI_FALLBACK_MODEL", "gemini-2.5-flash-lite")
GEMINI_MAX_OUTPUT_TOKENS = _get_int("GEMINI_MAX_OUTPUT_TOKENS", 8192)
...
MAX_TRANSCRIPT_SIZE_SINGLE = _get_int("MAX_TRANSCRIPT_SIZE_SINGLE", 600000)
...
GEMINI_MAX_SINGLE_CHARS = _get_int("GEMINI_MAX_SINGLE_CHARS", 600000)
GEMINI_CHUNK_CHARS = _get_int("GEMINI_CHUNK_CHARS", 300000)
